...
<label class="flex focus:shadow-none hover:text-gray-500" for="{{ $attributes['name'] }}">
    ...
    <span class="flex items-center justify-center appearance-none block text-gray-400 text-xxs uppercase font-semibold tracking-wide hover:text-gray-500">{!! html_entity_decode($attributes['label']) !!}</span>
</label>