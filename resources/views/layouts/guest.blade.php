<x-empty-layout class="guest flex h-screen">
    ...
    <div class="flex flex-col justify-between w-full lg:w-1/3">
        <header class="py-8 px-10 lg:px-20">
        ...
        <main class="px-10 mb-16 lg:px-20">
            ...
            <h2 class="mt-2 mb-14 text-sm text-gray-400">{{ $welcome }}</h2>
        ...
        <footer class="flex flex-col lg:flex-row items-center justify-between py-3 px-10 lg:px-20">
