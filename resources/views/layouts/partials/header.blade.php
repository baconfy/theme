<header class="flex justify-between items-center">
    ...
    <div class="flex items-center">
        ...
        <label for="by-modules-toggle" class="cursor-pointer ml-4 lg:ml-6">
            <svg class="w-7 h-7"  fill="none" viewBox="0 0 24 24">
        ...
        <button class="ml-4 lg:ml-6">
            <img class="w-10 h-10 rounded-full object-cover" src="https://api.adorable.io/avatars/144/karen-pais" />
        </button>
    </div>
</header>
